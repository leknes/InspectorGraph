...
{
    public class ComponentPortManager
    {
        ...
        public ComponentPortManager(GraphView graphView)
        {
        ...
        public void AddListViewInput(PortListView inputListView, SerializedProperty property, Func<SerializedProperty, SerializedProperty> converter)
        {
            ...
            property.RegisterValueChangedCallback<InspectorGraph>(inputListView, OnValueChanged);
        ...
        {
            property.RegisterValueChangedCallback<InspectorGraph>(input, AddInputNoCallback(input, property));
        }
...
public class ComponentPortManager
{
    ...
    private readonly Dictionary<Port, InputPortModel> _ports = new Dictionary<Port, InputPortModel>();
    ...
    private void ManipulateElementsToRemove(List<GraphElement> elementsToRemove)
    {
        foreach (GraphElement element in elementsToRemove)
        {
            ...
            input.OnDisconnected(edge);
            output.OnDisconnected(edge);
        }
    }
    ...
    private void ManipulateEdgesToCreate(List<Edge> edgesToCreate)
    {
        foreach (Edge edge in edgesToCreate)
        {
            ...
            input.OnConnected(edge);
            output.OnConnected(edge);
        }
    }
